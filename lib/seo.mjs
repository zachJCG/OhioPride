 ...
 *
 * `image` is assumed to be the 1200x630 site card. A page that points at a
 * differently shaped file must also give `imageWidth` and `imageHeight`, and
 * may give `twitterImage` when that shape does not survive X's 1.91:1 crop.
 * ------------------------------------------------------------------------- */
export const PAGES = [
  {
    url: '/',
  ...
  },
  {
    ...
    /* The invitation itself is the share card. It is 4:5, which Facebook,
     * LinkedIn, Slack and iMessage all render tall and legible; X is the one
     * consumer that would crop it, so it gets the pillarboxed 1200x630
     * rendering of the same flyer instead. */
    image: '/assets/img/events/cleveland-pride-hour.jpg',
    imageWidth: 1080,
    imageHeight: 1350,
    twitterImage: '/assets/img/events/cleveland-pride-hour-og.jpg',
    imageAlt:
