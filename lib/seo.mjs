...
export const PAGES = [
  ...
  },
  {
    ...
    description:
      'Join Ohio Pride PAC for a happy hour in support of our work. Wednesday, August 26, 2026, 6–8 PM at Cobblestone OTR in Cincinnati. RSVP today.',
    ogDescription:
      'A happy hour in support of the work of Ohio Pride PAC. Wed, Aug 26, 2026 · 6–8 PM · Cobblestone OTR, Cincinnati. RSVP today.',
    image: '/assets/img/events/cincinnati-pride-hour.jpg',
    imageAlt:
      "Cincinnati's Pride Hour — a happy hour in support of Ohio Pride PAC, August 26, 2026 at Cobblestone OTR.",
    priority: 0.7,
    changefreq: 'weekly',
    ...
    event: {
      ...
      startDate: '2026-08-26T18:00:00-04:00',
