...
export const PAGES = [
  ...
  },
  {
    ...
    description:
      "Ohio Pride PAC is taking Pride Hour city by city. Next up: Cleveland's Pride Hour, Sunday, September 20, 2026. See the host committee and RSVP.",
    image: '/assets/img/events/cleveland-pride-hour-og.jpg',
    imageAlt: "Cleveland's Pride Hour, Sunday September 20, 2026, at the Leather Stallion Saloon.",
    priority: 0.8,
    changefreq: 'weekly',
  },
  {
    ...
    description:
      'A happy hour in support of Ohio Pride PAC, hosted by leaders from across Northeast Ohio. Sunday, September 20, 2026, 4 to 6 PM in Cleveland.',
    image: '/assets/img/events/cleveland-pride-hour-og.jpg',
    imageAlt:
