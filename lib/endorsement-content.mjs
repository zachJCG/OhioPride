...
export const ENDORSEMENT_CONTENT = [
  ...
  {
    slug: 'jessica-miranda',
    match: 'jessica miranda',
    name: 'Jessica E. Miranda',
    photo: '/assets/endorsements/jessica-miranda.jpg',
    photoAlt:
      'Jessica Miranda in a light blue blazer smiling in a professional portrait on a sky blue background',
    tagline: 'An Auditor for everyone in Hamilton County.',
    /* Supabase carries the questionnaire's dropdown value, "County Auditor /
       Recorder / Treasurer / Clerk", and "Hamilton County" as the district.
       She holds the seat, so the second line says so and the county geography
       stays where it belongs, in the first fact below. */
    office: 'Hamilton County Auditor',
    district: 'Incumbent',
    region: 'Hamilton County, including Cincinnati and its suburbs',
    facts: [
      {
        label: 'Current role',
        value: 'Hamilton County Auditor since April 2024, running for a full term',
      },
      {
        label: 'Prior service',
        value: 'Ohio House District 28, 2019 to 2024, House Minority Whip',
      },
    ],
    summary:
      "Hamilton County's out Auditor, the former House Minority Whip who authored the amendments to protect marriage equality in Ohio, running for a full term.",
    meta:
      "Ohio Pride endorses Hamilton County Auditor Jessica E. Miranda, an out public servant who authored Ohio's marriage equality amendments, for a full term.",
    profile: [
      {
        heading: 'Why we endorsed Jessica',
        paragraphs: [
          "Jessica Miranda wrote the amendment. As a state representative she authored constitutional amendments to protect the Obergefell and Loving decisions in Ohio law, and when she introduced them at the Statehouse, Jim Obergefell himself stood beside her to deliver the remarks. She took what she calls big and loud stances on the House floor for trans Ohioans and LGBTQ+ youth at a time when doing so carried real cost. She is out, her children are part of our community, and she has never treated our fight as anyone's but her own.",
          "Her record beyond our issues is the record of a fighter for working people. She co-sponsored the law that finally closed Ohio's spousal rape loophole and used her own story as a survivor to get it passed. She sponsored the Ohio Equal Pay Act, co-founded the Ohio Gun Violence Prevention Caucus, and rose to House Minority Whip. Her constituents in the 28th District knew her as a public servant, not a politician, and Hamilton County has come to know her the same way.",
          'As Auditor, Miranda runs an office where there is no room for discrimination of any kind. It is signed on to equal pay pledges, its services are open to every resident regardless of identity, and she marches in county Pride alongside her staff. Her priorities are the ones every homeowner shares: fair property values, real transparency, and a modern office people can actually use. Brigid Kelly was the first woman to hold this office. Reelect Jessica Miranda this November and she will be the first woman to complete a full term as Hamilton County Auditor. She has earned it.',
        ],
      },
    ],
    pullQuote: {
      text: 'As an elected official, I work for everyone in our County, no exceptions.',
      attribution: 'Jessica E. Miranda, Ohio Pride endorsement questionnaire',
    },
    cta: [
      { label: 'Learn more at jessicaforohio.com', href: 'https://jessicaforohio.com' },
      { label: 'Read all endorsements', href: '/endorsements' },
    ],
  },
  {
  ...
  },
  {
    slug: 'mike-baker',
    match: 'mike baker',
    photo: '/assets/endorsements/mike-baker.jpg',
    photoAlt:
      'Mike Baker in a gray suit and blue tie with glasses and a beard, smiling in a professional portrait on a dark background',
    tagline: 'Showing up for Lorain County families.',
    office: 'Ohio House of Representatives',
    district: 'House District 52',
    region: 'Lorain County, including Elyria',
    facts: [
      {
        label: 'Background',
        value: 'Founder of First Choice Photography, father of four',
      },
      {
        label: 'Community',
        value: 'President of Elyria Little League West, 15 years in Scouting leadership',
      },
    ],
    summary:
      'Elyria small business owner, Scout leader, and dad of four running for House District 52 with a clear commitment to the Ohio Fairness Act.',
    meta:
      'Ohio Pride endorses Elyria small business owner and Scout leader Mike Baker for Ohio House District 52.',
    profile: [
      {
        heading: 'Why we endorsed Mike',
        paragraphs: [
          'Mike Baker is a husband, a father of four, and a small business owner from Elyria who has spent more than 15 years showing up for the kids in his community. He founded First Choice Photography in 2008 and built it into a company that employs local people and shoots the games, portraits, and milestones families keep. He serves as president of Elyria Little League West and as a district-level Scouting volunteer, the kind of leadership that means early mornings, long weekends, and no headlines.',
          'His commitments to our community are direct. Baker will vote for the Ohio Fairness Act because no Ohioan should face discrimination in employment, housing, or public accommodations because of who they are or who they love. He supports a statewide ban on conversion therapy for minors, stronger anti-bullying protections for LGBTQ+ students, and access to healthcare that lets adults make decisions with their doctors. On the bills that targeted our community in the last General Assembly, he told us plainly he would have voted no on House Bill 68, Senate Bill 104, and House Bill 8.',
          'Baker also knows how to talk to the voters who decide races like this one. He makes the case for equality to independents as basic fairness, economic growth, and personal freedom, the values most Lorain County families already share. House District 52 deserves a representative who treats every constituent with dignity and respect, and who has the record in his own community to prove he means it. Mike Baker is that candidate.',
        ],
      },
    ],
    pullQuote: {
      text: 'No Ohioan should face discrimination in employment, housing, or public accommodations because of who they are or who they love.',
      attribution: 'Mike Baker, Ohio Pride endorsement questionnaire',
    },
    cta: [
      { label: 'Learn more at bakerforohio.com', href: 'https://bakerforohio.com' },
      { label: 'Read all endorsements', href: '/endorsements' },
    ],
  },
  {
    slug: 'sarah-henry',
    match: 'sarah henry',
    photo: '/assets/endorsements/sarah-henry.jpg',
    photoAlt: 'Sarah Henry in a brown blazer with arms crossed, smiling in front of glass cases of law books',
    tagline: 'A courtroom where everyone is heard.',
    /* Judicial race. Supabase carries the questionnaire's "Court of Common
       Pleas (General Division)" with Hamilton as the county; the entry prints
       the county in the office line, the same way Job Perry's does, and the
       copy stays descriptive: fairness, dignity, access to justice, and no
       policy pledges. */
    office: 'Hamilton County Court of Common Pleas',
    district: 'General Division',
    region: 'Hamilton County, including Cincinnati and surrounding communities',
    facts: [
      {
        label: 'Current role',
        value: 'Administrative Magistrate, Hamilton County Juvenile Court',
      },
      {
        label: 'Experience',
        value:
          'Public defender and legal aid attorney with trial experience in Alaska, Kentucky, and Ohio',
      },
    ],
    summary:
      'Juvenile Court magistrate and former public defender running to bring a career of service and a courtroom where everyone is heard to the Hamilton County bench.',
    meta:
      'Ohio Pride endorses Magistrate Sarah Henry, a former public defender and legal aid attorney, for the Hamilton County Court of Common Pleas.',
    profile: [
      {
        heading: 'Why we endorsed Sarah',
        paragraphs: [
          "Sarah Henry has spent her entire career on the side of people who needed someone in their corner. She began as a public defender, moved to legal aid, and tried jury, bench, capital, and civil matters across Alaska, Kentucky, and Ohio. Since 2023 she has served as Administrative Magistrate of the Hamilton County Juvenile Court, where she presides over two dockets, oversees the court's mediation program, and launched explainer videos so families walk into court knowing what to expect.",
          'Her commitment to our community shows in how she runs a courtroom. Henry has committed to plain language, patience with people representing themselves, and regular implicit bias training for herself and her staff. In her words, everyone is heard, not just with their words but in validation of their right to exist. She supervised an employee through a gender transition, she has family and close friends in our community, and she told us her own values and demand for equality run parallel to ours.',
          "Henry also knows what it takes to build something for people who have less. She helped organize the union at Legal Aid of Greater Cincinnati and worked to end youth homelessness through the Children's Law Center. Born on a Navy base and raised in Cincinnati by a Navy officer and two educators, she is a Mount Washington Community Council board member, a former Girl Scout troop leader, and a mom. Hamilton County residents meet the justice system in the Court of Common Pleas. They deserve a judge who sees all of them. Sarah Henry will.",
        ],
      },
    ],
    pullQuote: {
      text: 'Everyone is heard, not just with their words but in validation of their right to exist.',
      attribution: 'Sarah Henry, Ohio Pride endorsement questionnaire',
    },
    cta: [
      { label: 'Learn more at votesarahhenry.com', href: 'https://votesarahhenry.com' },
      { label: 'Read all endorsements', href: '/endorsements' },
    ],
  },
  {
    slug: 'lora-covrett',
    match: 'lora covrett',
    photo: '/assets/endorsements/lora-covrett.jpg',
    photoAlt: 'Lora Covrett smiling outdoors in a plaid shirt and glasses',
    tagline: 'Representation that reaches rural Ohio.',
    region: 'Rural central Ohio, including Marengo and Morrow County',
    facts: [
      { label: 'Background', value: 'IT professional of more than 20 years' },
      { label: 'Home', value: 'Marengo, on a mini-farm with her wife' },
    ],
    summary:
      'Out IT professional from Marengo running to bring rural Ohio real LGBTQ+ representation and a fairness-first agenda in the Ohio House.',
    meta:
      'Ohio Pride endorses Lora Covrett, an out IT professional running to give rural Ohioans LGBTQ+ representation in the Ohio House.',
    profile: [
      {
        heading: 'Why we endorsed Lora',
        paragraphs: [
          'Lora Covrett is running to give rural Ohio something it has rarely had: representation that sees LGBTQ+ people and says so out loud. She is an out member of our community, married to her wife since 2014, and she lives in Marengo on a mini-farm with a house full of feathered and furry animals. She has spent more than 20 years as an IT professional, and she wants to bring that data and analytics discipline to the Statehouse to write legislation that actually helps people.',
          'Her commitments to our community are unambiguous. Covrett supports the Ohio Fairness Act, backs a statewide ban on conversion therapy for minors, and told us plainly she would have voted no on House Bill 249 and House Bill 172, bills she sees as obstacles to safe, life-saving care. She has pledged to oppose any legislation that singles out the trans or broader LGBTQ+ community, and to direct state resources toward mental health networks, crisis intervention, and housing programs so that rural districts are not left behind.',
          "Covrett makes the case for equality the way it lands in a rural district: as a matter of fairness that touches everyone. Her top priorities are overturning Ohio's constitutional ban on same-sex marriage, ensuring access to affordable healthcare and medication including non-emergency medical transportation for rural patients, and expanding safe, affordable housing. She wants voters to know she is there to represent all people, and that after too much anger and division, Ohio is ready for some inclusion and kindness. We agree.",
        ],
      },
    ],
    pullQuote: {
      text: 'It lets rural members of our LGBTQ+ community know that they will have representation.',
      attribution: 'Lora Covrett, Ohio Pride endorsement questionnaire',
    },
    cta: [
      {
        label: 'Learn more at loracovrettforohio87.com',
        href: 'https://loracovrettforohio87.com',
      },
      { label: 'Read all endorsements', href: '/endorsements' },
    ],
  },
  {
    slug: 'manisha-kotian',
    match: 'manisha kotian',
    photo: '/assets/endorsements/manisha-kotian.jpg',
    photoAlt: 'Manisha Kotian smiling in a cream blazer over a black top',
    tagline: 'A fair trial for everyone who enters.',
    /* Judicial race. Supabase carries the questionnaire's "Court of Common
       Pleas (General Division)" with Hamilton as the county; the entry prints
       the county in the office line, the same way Sarah Henry's does, and the
       copy stays descriptive: fairness, dignity, access to justice, and no
       policy pledges. */
    office: 'Hamilton County Court of Common Pleas',
    district: 'General Division',
    ...
    facts: [
      {
        label: 'Experience',
        value: 'More than 30 years in law and as a trained mediator',
      },
      {
        label: 'Service',
        value: 'Legal Aid Society of Greater Cincinnati, AmeriCorps, EEO mediation',
      },
    ],
    summary:
      'Attorney, mediator, and 30-year advocate for families running for the Hamilton County bench on a promise of a fair trial for everyone who enters.',
    meta:
      'Ohio Pride endorses attorney and mediator Manisha Kotian, with 30 years serving families and a commitment to a fair courtroom for everyone.',
    profile: [
      {
        heading: 'Why we endorsed Manisha',
        paragraphs: [
          "Manisha Kotian has spent more than 30 years in the law and much of it in the role of a neutral, working to make sure people are treated fairly. A significant part of her career has been serving as a mediator on the Postal Service's Equal Employment Opportunity cases, where her job was to ensure there were no violations based on race, religion, sex, gender identity, sexual orientation, age, or disability. She calls that work a highlight of her career, and it shows in how she talks about the bench.",
          'Her commitment to our community is direct. Kotian believes the measure of a society is how it treats its children and its most vulnerable, and she counts LGBTQ+ Ohioans among those our current moment has left exposed. She has represented LGBTQ+ clients through their divorces, has always run her practice to be inclusive and supportive, and says the principles of Obergefell shape her legal philosophy. To her, LGBTQ+ rights are human rights, and everyone who enters her courtroom deserves a fair trial free of bias.',
          'Her record is deep and varied. She has represented children who are victims of abuse and neglect through the Legal Aid Society of Greater Cincinnati, served in AmeriCorps, done pro bono work, and for 20 years owned a union heavy-highway concrete company. She has never had a bar complaint, disciplinary action, or lawsuit filed against her. Her temperament is collaborative: she explains the process, gives people room to reach their own resolution, and when they cannot, she holds a fair trial. People come to agreement in her courtroom, she says, because they feel seen and heard. That is exactly the judge Hamilton County deserves.',
        ],
      },
    ],
    pullQuote: {
      text: 'LGBTQ+ rights are human rights. I want to ensure everyone who enters my courtroom has access to a fair trial free of bias.',
      attribution: 'Manisha Kotian, Ohio Pride endorsement questionnaire',
    },
    cta: [
      { label: 'Learn more at kotianforjudge.com', href: 'https://kotianforjudge.com' },
      { label: 'Read all endorsements', href: '/endorsements' },
    ],
  },
  {
    slug: 'tiffany-evans',
    match: 'tiffany evans',
    photo: '/assets/endorsements/tiffany-evans.jpg',
    photoAlt: 'Tiffany Evans in a green blazer seated and smiling',
    tagline: 'A courtroom where every family is treated with dignity.',
    /* Judicial race. Supabase carries the questionnaire's bare "Domestic
       Relations Court" with Hamilton as the county, so the entry prints the
       county in the office line and "Judge" as the seat. Descriptive copy
       only: fairness, dignity, access to justice, no policy pledges. */
    office: 'Hamilton County Domestic Relations Court',
    district: 'Judge',
    region: 'Hamilton County, including Cincinnati and surrounding communities',
    facts: [
      { label: 'Current role', value: 'Domestic Relations Magistrate and Mediator' },
      {
        label: 'Experience',
        value: 'Nearly 20 years serving families in six court roles',
      },
    ],
    summary:
      'Domestic Relations Magistrate and lifelong child advocate running for judge on a promise that every family is treated with dignity.',
    meta:
      'Ohio Pride endorses Magistrate Tiffany Evans, a longtime child advocate, for the Hamilton County Domestic Relations Court.',
    profile: [
      {
        heading: 'Why we endorsed Tiffany',
        paragraphs: [
          'Tiffany Evans has built her whole career in the court where families go when things are hardest. Over nearly 20 years she has served in six roles within the system: child advocate, guardian ad litem, domestic relations attorney, parenting coordinator, and now Magistrate and Mediator in Domestic Relations Court. She has adjudicated hundreds of civil protection order cases, serves on the Hamilton County Domestic Violence Task Force, and has volunteered for abused women and children both here and abroad. Her own childhood experience in Domestic Relations Court is what set her on this path.',
          'Her commitment to our community is personal and clear. Her uncle, whom she adores, is part of the LGBTQ+ community, and to this day her closest friends are too. She spent thirteen years in New York City in part because she cherished the diversity, and she calls the arrival of the Obergefell decision something she is proud and heartened to have witnessed. She seeks this endorsement, she says, because the LGBTQ+ community matters deeply to her, and because she and Ohio Pride stand for the same thing: loving all.',
          'To Evans, fairness in a courtroom is the bare minimum we owe each other, that every person is treated with dignity and respect no matter their gender identity, race, religion, or ethnicity. Her judicial temperament is collaborative: she explains the process to litigants who walk in frightened and unsure, answers their questions, and helps them reach their own resolutions. People come to agreement in her courtroom because they feel seen and heard. She believes that if children are raised in loving, healthy households of every kind, our world is a better place. That belief is the reason she is running, and the reason we are proud to endorse her.',
        ],
      },
    ],
    pullQuote: {
      text: 'The measure of a society is how it treats its children and its most vulnerable. Everyone who enters my courtroom is treated with dignity.',
      attribution: 'Tiffany Evans, Ohio Pride endorsement questionnaire',
    },
    cta: [
      { label: 'Learn more at votetiffanyevans.com', href: 'https://votetiffanyevans.com' },
      { label: 'Read all endorsements', href: '/endorsements' },
    ],
  },
  {
    slug: 'noah-spinner',
    /* Supabase carries the name on the application; the campaign runs as
       "J. Noah Spinner". The record of what was filed stays in the database. */
    match: 'noah spinner',
    name: 'J. Noah Spinner',
    photo: '/assets/endorsements/noah-spinner.jpg',
    photoAlt:
      'J. Noah Spinner smiling in a charcoal quarter-zip beside the Cuyahoga River in Cuyahoga Falls',
    tagline: 'An ally who will have our backs in District 31.',
    region:
      'Summit County, including Cuyahoga Falls, Barberton, Copley, Bath, Norton, and Richfield',
    facts: [
      { label: 'Background', value: 'Attorney, University of Akron School of Law' },
      {
        label: 'Community',
        value: 'Eagle Scout and Cuyahoga Falls Library Board of Trustees',
      },
    ],
    summary:
      "Cuyahoga Falls attorney, Eagle Scout, and library trustee running in one of Ohio's most competitive House races with a clear commitment to the Ohio Fairness Act.",
    meta:
      'Ohio Pride endorses J. Noah Spinner, a Cuyahoga Falls attorney and Eagle Scout who will vote for the Ohio Fairness Act, for Ohio House District 31.',
    profile: [
      {
        heading: 'Why we endorsed Noah',
        paragraphs: [
          'J. Noah Spinner has called Summit County home his entire life. He grew up in a busy Cuyahoga Falls household with his parents and three siblings, graduated from Cuyahoga Falls High School and the University of Akron, and earned his law degree at the University of Akron School of Law. He is an Eagle Scout who has served on the staff of Camp Manatoc, a member of the Cuyahoga Falls Library Board of Trustees, a cyclist and advocate for cancer research, and a Greater Akron Chamber 30 for the Future honoree. The proud grandson, nephew, and brother of public educators, he is running to ensure access to healthcare, strengthen public education, and restore affordability for working families.',
          "His commitments to our community are direct. Spinner will vote for the Ohio Fairness Act, supports a statewide ban on conversion therapy, and has pledged to vote against legislation that harms LGBTQ+ Ohioans. He has immediate family members and close friends in our community, and he told us it has been personally disheartening to watch them be attacked by their own state government. Because a state representative's biggest job is writing Ohio's budget, he has promised that state dollars will go toward healthcare and services that support Ohioans, not culture war attacks on our trans neighbors. In his words, conversion therapy has no place in the State of Ohio.",
          "Spinner also knows how to win the voters who decide a seat like this one. House District 31 is one of the most competitive open seats in Ohio, and he makes the case the way his neighbors live it: rising costs, property taxes, and healthcare do not care what party you belong to or who you love. He has promised to fight for every resident of District 31 regardless of party, religion, or sexual orientation, and to have our community's backs every step of the way. We believe him, and we are proud to stand with him.",
        ],
      },
    ],
    pullQuote: {
      text: "I will have our LGBTQ+ communities' backs every step of the way.",
      attribution: 'J. Noah Spinner, Ohio Pride endorsement questionnaire',
    },
    cta: [
      { label: 'Learn more at spinnerforohio.com', href: 'https://spinnerforohio.com' },
      { label: 'Read all endorsements', href: '/endorsements' },
    ],
  },
];
