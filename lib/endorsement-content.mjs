...
export const ENDORSEMENT_CONTENT = [
  ...
  },
  {
    slug: 'paul-kurtz',
    match: 'paul kurtz',
    /* Versioned filenames on purpose: /assets/endorsements/* and
       /assets/social/* ship a 7 day max-age, so replacing a photo in
       place leaves everyone who already loaded it on the old one for up
       to a week. A new name is the cache bust. */
    photo: '/assets/endorsements/paul-kurtz-headshot.jpg',
    ogImage: '/assets/social/og-endorsement-paul-kurtz-headshot.png',
    photoAlt:
