...
Any change that would affect a legislator's editorial score. The scoring layer is a deliberate human-judgment domain. If a new committee vote would change how a legislator's record should be characterized, Claude flags it in the report but does not touch votes_score, sponsorship_score, or news_score on the legislators table.
