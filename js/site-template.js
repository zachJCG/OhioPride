...
(function () {
  ...
  var FOOTER_HTML = [
    ...
    '    <div>',
    '      &copy; 2026 Ohio Pride PAC. All rights reserved.',
    '      <span class="ohp-footer-sep" aria-hidden="true">&middot;</span>',
    '      <a class="ohp-footer-admin" href="/admin/endorsements/login">Board Sign In</a>',
    '    </div>',
