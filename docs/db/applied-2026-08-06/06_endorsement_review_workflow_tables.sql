...
create table public.endorsement_reviews (
  ...
  reviewer_name text,
  -- Superseded 2026-08-07: the vote scale is now ('endorse','decline','abstain').
  -- See supabase/migrations/20260807001000_endorsement_votes_endorse_decline_abstain.sql.
