...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("statusBadge").style.border =
    "1px solid " + bill.statusColor + "44";
  ...
  catContainer.innerHTML = bill.categoryLabels
    .map(
      (c) =>
