...
(function () {
  ...
  var STYLES = [
    ...
    '.ohp-gp__alt{font-family:Montserrat,system-ui,sans-serif;font-weight:700;font-size:13.5px;',
  ...
  function build() {
    ...
    backdrop.innerHTML = [
      ...
      '      <a class="ohp-gp__alt" href="/governor-guide/other-candidates">See the whole ballot</a>',
