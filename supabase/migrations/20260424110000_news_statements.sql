...
values
  ...
  ('25-s-01', 'senate', 25, '2024-01-24', 'pro',  1, 'Motioned to adjourn before HB 68 override vote',
     'DeMora filed a procedural motion to adjourn on the override day, a visible protest of the vote''s scheduling.'),
